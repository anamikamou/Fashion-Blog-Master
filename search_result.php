...
<section class="section blog-area">
    <div class="container">
    	<b>Search For:</b> <?php echo $search; ?> <br><br>
			<div class="row">
							<?php
								$sql = "SELECT * FROM post_table WHERE `post_keyword` = '$search'  OR `category` = '$search' OR `sub_category` = '$search' OR `sub_sub_category` = '$search' ";
								$act = $db->query($sql);
								$i = 1;
